        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-wrap sm:flex-nowrap items-center justify-between my-7 relative">
          ...
          <div className="order-2 flex-1 flex items-center justify-start gap-5 sm:order-1">
            <a href="https://www.instagram.com/laobansoyabeancurd" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              className="hover:text-pink-600 hover:scale-110 transition-all duration-200">
          ...
          {/* Logo */}
          <div className={`order-1 sm:pb-0 pb-6 w-full flex  justify-center sm:order-2 sm:w-auto sm:flex-1 ${disableLogo ? 'hidden sm:flex' : 'flex'}`}>
            <Link href="/" className="w-full flex items-center select-none justify-center">
